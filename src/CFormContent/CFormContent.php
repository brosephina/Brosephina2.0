...
class CFormContent extends CForm {
  ...
  public function __construct($content) {
    ...
    $this->AddElement(new CFormElementHidden('id', array('value'=>$content['id'])))
         ...
         ->AddElement(new CFormElementText('type', array('label'=>'type, (post or page):','value'=>$content['type'])))
         ->AddElement(new CFormElementText('filter', array('label'=>'filter, (plain, bbcode or htmlpurify):','value'=>$content['filter'])))
